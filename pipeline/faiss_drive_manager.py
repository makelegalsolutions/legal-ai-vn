# Cell 12: Ghi đè file faiss_drive_manager.py hoàn chỉnh
%%writefile pipeline/faiss_drive_manager.py
"""
...
# ========================================
# LOAD FAISS VERSION FROM DRIVE (QUAN TRỌNG)
# ========================================
...
print("✅ faiss_drive_manager.py updated successfully!")
